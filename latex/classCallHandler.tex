...
\begin{DoxyCompactList}\small\item\em Gibt an, ob der \mbox{\hyperlink{classCallHandler}{Call\+Handler}} fertig ist. \end{DoxyCompactList}\item 
bool \mbox{\hyperlink{classCallHandler_a661d0bfb7f4db568304834ed0e33205a}{paused}} = false
\begin{DoxyCompactList}\small\item\em Gibt an, ob der Servo pausiert ist, wird zu true gesetzt, wenn der Stoppknopf gedrückt wird. \end{DoxyCompactList}\end{DoxyCompactItemize}
...
\DoxyCodeLine{00018   \textcolor{keywordflow}{for} (\mbox{\hyperlink{structCallable}{Callable}}** callPtr = \mbox{\hyperlink{classCallHandler_a70bf3c03de1953c55fc468b73c77e0f2}{callPtrs}}; callPtr <= \mbox{\hyperlink{classCallHandler_a1bb0098f92adc006de8f8cd69c373fb2}{lastCallPtr}}; callPtr++) \{}
...
\begin{center}
\leavevmode
\includegraphics[width=313pt]{classCallHandler_a49ab239f771b84300df21bd426788c3e_icgraph}
\end{center}
\end{figure}
...
Calls werden im \href{https://www.geeksforgeeks.org/stack-vs-heap-memory-allocation/}{\texttt{ Heap}} gespeichert, um sie zwischen Funktionen hin-\/ und hergeben zu können und sie zu benutzen nachdem die Exekution abgeschlossen ist (bzw an das \mbox{\hyperlink{classCallHandler}{Call\+Handler}} Objekt). Sie müssen aber such manuell mithilfe von \mbox{\hyperlink{classCallHandler_a49ab239f771b84300df21bd426788c3e}{Call\+Handler\+::delete\+Calls}} gelöscht werden 
\end{DoxyNote}
...
\DoxyCodeLine{00038   (*currCallPtr)-\/>\mbox{\hyperlink{structCallable_a0e146c329fbdf8720a9541f60fe910e9}{run}}();}
...
\begin{center}
\leavevmode
\includegraphics[width=298pt]{classCallHandler_afc5654ccaa266f3a81f8230afdb1c2a0_icgraph}
\end{center}
\end{figure}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{00048 \{}
\DoxyCodeLine{00049   \textcolor{keywordflow}{if} (!\mbox{\hyperlink{classCallHandler_ab56ebeeecd75a34d9fdda13fff68cda7}{running}}||\mbox{\hyperlink{classCallHandler_a661d0bfb7f4db568304834ed0e33205a}{paused}}) \{}
...
\DoxyCodeLine{00059     (*currCallPtr)-\/>\mbox{\hyperlink{structCallable_a0e146c329fbdf8720a9541f60fe910e9}{run}}();\textcolor{comment}{//-\/>currCall-\/>run();}}
\DoxyCodeLine{00060   \}}
\DoxyCodeLine{00061 \}}
...
\mbox{\Hypertarget{classCallHandler_a661d0bfb7f4db568304834ed0e33205a}\label{classCallHandler_a661d0bfb7f4db568304834ed0e33205a}} 
\index{CallHandler@{CallHandler}!paused@{paused}}
\index{paused@{paused}!CallHandler@{CallHandler}}
\doxysubsubsection{\texorpdfstring{paused}{paused}}
{\footnotesize\ttfamily bool Call\+Handler\+::paused = false}



Gibt an, ob der Servo pausiert ist, wird zu true gesetzt, wenn der Stoppknopf gedrückt wird. 



Definiert in Zeile \mbox{\hyperlink{callHandler_8h_source_l00055}{55}} der Datei \mbox{\hyperlink{callHandler_8h_source}{call\+Handler.\+h}}.
