...
\begin{DoxyCompactList}\small\item\em Sagt aus, ob call\+Ptrs zu einer gültigen Speicheradresse zeigt. \end{DoxyCompactList}\end{DoxyCompactItemize}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{13                               \{}
\DoxyCodeLine{14   \textcolor{keywordflow}{if} (!\mbox{\hyperlink{classCallHandler_a1ee97c59315e54746cef82a406a49236}{callsSet}}) \{}
\DoxyCodeLine{15     \textcolor{keywordflow}{return};}
\DoxyCodeLine{16   \}}
\DoxyCodeLine{17   \mbox{\hyperlink{classCallHandler_a1ee97c59315e54746cef82a406a49236}{callsSet}} = \textcolor{keyword}{false};}
\DoxyCodeLine{18   \textcolor{keywordflow}{for} (\mbox{\hyperlink{structCallable}{Callable}}** callPtr = \mbox{\hyperlink{classCallHandler_a70bf3c03de1953c55fc468b73c77e0f2}{callPtrs}}; callPtr <= \mbox{\hyperlink{classCallHandler_a1bb0098f92adc006de8f8cd69c373fb2}{lastCallPtr}}; callPtr++) \{}
\DoxyCodeLine{19     \textcolor{keyword}{delete} *callPtr;}
\DoxyCodeLine{20   \}}
\DoxyCodeLine{21   \textcolor{keyword}{delete} \mbox{\hyperlink{classCallHandler_a70bf3c03de1953c55fc468b73c77e0f2}{callPtrs}};}
\DoxyCodeLine{22 \}}
...
Definiert in Zeile 29 der Datei call\+Handler.\+ino.


\begin{DoxyCode}{0}
\DoxyCodeLine{29                                                                  \{}
\DoxyCodeLine{30   \textcolor{comment}{/*if(callsSet)\{ //doing this would result in two sets of calls being in heap at once}}
\DoxyCodeLine{31 \textcolor{comment}{    deleteCalls(); //solution is to delete previus calls before initializing a new one}}
\DoxyCodeLine{32 \textcolor{comment}{  \}*/}}
\DoxyCodeLine{33   \mbox{\hyperlink{classCallHandler_a70bf3c03de1953c55fc468b73c77e0f2}{callPtrs}} = newCallPtrs;}
\DoxyCodeLine{34   \mbox{\hyperlink{classCallHandler_a1ee97c59315e54746cef82a406a49236}{callsSet}} = \textcolor{keyword}{true};}
\DoxyCodeLine{35   \mbox{\hyperlink{classCallHandler_a090fccd59cdc5b99f5f17f1215c4fd29}{currCallPtr}} = \mbox{\hyperlink{classCallHandler_a70bf3c03de1953c55fc468b73c77e0f2}{callPtrs}};}
\DoxyCodeLine{36   (*currCallPtr)-\/>\mbox{\hyperlink{structCallable_a0e146c329fbdf8720a9541f60fe910e9}{run}}();}
\DoxyCodeLine{37   \mbox{\hyperlink{classCallHandler_a1bb0098f92adc006de8f8cd69c373fb2}{lastCallPtr}} = \mbox{\hyperlink{classCallHandler_a70bf3c03de1953c55fc468b73c77e0f2}{callPtrs}} + nCalls -\/ 1;}
\DoxyCodeLine{38   \mbox{\hyperlink{classCallHandler_a2c98c2be5b62fafe94b32e3a0f68c84d}{lastCallT}} = millis();}
\DoxyCodeLine{39   \mbox{\hyperlink{classCallHandler_ab56ebeeecd75a34d9fdda13fff68cda7}{running}} = \textcolor{keyword}{true};}
\DoxyCodeLine{40 \}}
...
Definiert in Zeile 45 der Datei call\+Handler.\+ino.


\begin{DoxyCode}{0}
\DoxyCodeLine{45                          \{}
\DoxyCodeLine{46   \textcolor{keywordflow}{if} (!\mbox{\hyperlink{classCallHandler_ab56ebeeecd75a34d9fdda13fff68cda7}{running}}) \{}
\DoxyCodeLine{47     \textcolor{keywordflow}{return};}
\DoxyCodeLine{48   \}}
\DoxyCodeLine{49   \mbox{\hyperlink{header_8h_a9d1a8265fefddad5533f063ef338d59f}{time\_t}} timePassed = millis() -\/ \mbox{\hyperlink{classCallHandler_a2c98c2be5b62fafe94b32e3a0f68c84d}{lastCallT}};}
\DoxyCodeLine{50   \textcolor{keywordflow}{if} ((*currCallPtr)-\/>isDone()) \{\textcolor{comment}{//-\/>currCall-\/>isDone()}}
\DoxyCodeLine{51     \textcolor{keywordflow}{if} (\mbox{\hyperlink{classCallHandler_a090fccd59cdc5b99f5f17f1215c4fd29}{currCallPtr}} == \mbox{\hyperlink{classCallHandler_a1bb0098f92adc006de8f8cd69c373fb2}{lastCallPtr}}) \{}
\DoxyCodeLine{52       \mbox{\hyperlink{classCallHandler_ab56ebeeecd75a34d9fdda13fff68cda7}{running}} = \textcolor{keyword}{false};}
\DoxyCodeLine{53       \textcolor{keywordflow}{return};}
\DoxyCodeLine{54     \}}
\DoxyCodeLine{55     \mbox{\hyperlink{classCallHandler_a090fccd59cdc5b99f5f17f1215c4fd29}{currCallPtr}}++;}
\DoxyCodeLine{56     (*currCallPtr)-\/>\mbox{\hyperlink{structCallable_a0e146c329fbdf8720a9541f60fe910e9}{run}}();\textcolor{comment}{//-\/>currCall-\/>run();}}
\DoxyCodeLine{57   \}}
\DoxyCodeLine{58 \}}
...
Sagt aus, ob call\+Ptrs zu einer gültigen Speicheradresse zeigt. 



Definiert in Zeile 42 der Datei call\+Handler.\+h.
...
Es handelt sich hierbei um einen Pointer-\/\+Pointer. Der Pointer zeigt zu einer Stelle in der call\+Ptrs Liste, die wiederum zum tatsächlichen Call zeigt 

Definiert in Zeile 27 der Datei call\+Handler.\+h.
...
Definiert in Zeile 32 der Datei call\+Handler.\+h.
...
Definiert in Zeile 37 der Datei call\+Handler.\+h.
...
Definiert in Zeile 45 der Datei call\+Handler.\+h.
