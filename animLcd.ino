 ...
 * @details Überschreibt den standart print Befehl für String&, das heißt der Text wird als Variable übergeben, z.B.: \code lcd.print(text); \endcode Für eigene Character einfach die Nummer des Characters in den Text einfügen (<b>\1```n```</b> für den ```n```-ten Character), \1 für Leerzeichen, das nicht in Zeilenumbruch resultiert.
 * @param text 
 */
